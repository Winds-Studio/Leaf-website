    ...
    performance: {
        ...
        dab: {
            ...
            "blacklisted-entities": {
                ...
                desc: `DAB 黑名单，名单内的生物将不受 DAB 的影响。<br>
                    ...
                    <br>
                    黑名单格式：\`[villager]\` 或 \`[villager, zombified_piglin]\`（可参见 [Paper 的 Javadoc](https://jd.papermc.io/paper/1.21.8/org/bukkit/entity/EntityType.html) 查看所有实体类型）。<br>
                    <br>
        ...
        "skip-ai-for-non-aware-mob": {
            ...
            desc: `是否跳过同时处于 _不活跃_ 且 _无感知_ 状态的生物的 AI tick 计算。<br>
                被设为无感知的生物在重新变为活跃之前将不会自主活动，也不会在与其交互时作出反应。更多信息请参阅 [Mob.html#setAware(boolean)](https://jd.papermc.io/paper/1.21.8/org/bukkit/entity/Mob.html#setAware(boolean))。<br>
                <br>
                __⚡推荐值：\`true\`__
                <table>
                <tr><td><b>基于目标的推荐值</b></td><td></td></tr>
