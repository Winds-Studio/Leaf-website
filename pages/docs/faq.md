...
You can refer to [YouHaveTrouble's guide](https://github.com/YouHaveTrouble/minecraft-optimization) and [Paper-chan optimization guide](https://paper-chan.moe/paper-optimization/), or [NitWikit optimization guide](https://nitwikit.8aka.org/java/advance/optimize/intro/) made by the community (For Chinese user).
