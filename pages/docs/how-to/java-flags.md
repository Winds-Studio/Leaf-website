...
Proper optimization requires a methodical approach. **Refer to the detailed steps outlined in the ["Optimize Your Leaf Server"](../how-to/optimize-leaf-server.md) guide for _how_ to perform these essential practices.** In summary, always:
