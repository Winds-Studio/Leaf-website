---
title: Optimize Leaf Server
---

import { Callout } from "fumadocs-ui/components/callout"

<Callout type="warn">
  Dieser Inhalt wurde für die Versionen 1.21.4/5 geschrieben und trifft möglicherweise nicht
  vollständig auf die neueste Version zu. Bitte mit Vorsicht genießen.
</Callout>
