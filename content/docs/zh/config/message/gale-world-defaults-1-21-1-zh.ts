...
const zh: ConfigMessages<typeof config> = {
  "gameplay-mechanics": {
    ...
    "entity-wake-up-duration-ratio-standard-deviation": {
      desc: `如果将此值设为 > \`0\`，则唤醒不活跃实体的过程会分布在一段时间内，而不是同时唤醒大量实体。<br>
                这使实体的行为更加自然。<br>
                <br>
    ...
    fixes: {
      ...
      "mc-31819": {
        desc: `是否修复 [MC-31819](https://bugs.mojang.com/browse/MC-31819)。
                    <table>
      ...
      "mc-238526": {
        desc: `是否修复 [MC-238526](https://bugs.mojang.com/browse/MC-238526)。
                    <table>
                    <tr><td></td><td><b>默认值</b></td><td></td></tr>
                    <tr><td><b>推荐值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><i>Leaf</i></td><td><i>Paper</i></td><td><i>原版</i></td></tr>
    ...
    "hide-flames-on-entities-with-fire-resistance": {
      desc: `对于拥有火焰抗性效果的实体，是否在他们着火时隐藏视觉火焰。
                <table>
                <tr><td></td><td><b>默认值</b></td><td></td><td></td></tr>
                <tr><td><b>推荐值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><i>Leaf</i></td><td><i>Paper</i></td><td><i>原版</i></td></tr>
                <tr><td>-<br></td><td><code>false</code></td><td><code>false</code></td><td><code>false</code></td></tr>
    ...
    technical: {
      "load-portal-destination-chunk-before-entity-teleport": {
        desc: `当实体通过传送门时，是否在传送前完全加载目的地的区块。<br>
    ...
    "try-respawn-ender-dragon-after-end-crystal-place": {
      desc: `当末影水晶被放置在返回传送门的正确位置时，是否尝试重生末影龙。
                <table>
                <tr><td></td><td><b>默认值</b></td><td></td><td></td></tr>
                <tr><td><b>推荐值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><i>Leaf</i></td><td><i>Paper</i></td><td><i>原版</i></td></tr>
                <tr><td>-<br></td><td><code>true</code></td><td><code>true</code></td><td><code>true</code></td></tr>
  ...
  "small-optimizations": {
    ...
    "max-projectile-chunk-loads": {
      ...
      "per-tick": {
        desc: `单个世界中所有弹射物在一个 tick 中可以同时加载的最大区块数。<br>
                    <br>
    ...
    "reduced-intervals": {
      "acquire-poi-for-stuck-entity": {
        desc: `被卡住的生物尝试搜寻兴趣点（比如在矿车上的村民尝试获 Poi 点，又称工作方块）的额外间隔，为原有间隔基础上的额外时间间隔。<br>
                    （单位：tick）<br>
          ...
          minecart: {
            ...
            "temporary-immunity": {
              ...
              "check-for-minecart-near-item-interval": {
                desc: `每个漏斗矿车检查附近掉落物的频率，以给予矿车临时免疫，免受 \`interval\` 的影响。<br>
                                    （单位：tick）<br>
              ...
              "check-for-minecart-near-item-while-active": {
                desc: `是否检查 __活跃__ 状态的掉落物附近的漏斗矿车，以给予矿车临时免疫，免受 \`interval\` 的影响。
                                    <table>
                                    <tr><td></td><td><b>默认值</b></td><td></td><td></td></tr>
                                    <tr><td><b>推荐值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><i>Leaf</i></td><td><i>Paper</i></td><td><i>原版</i></td></tr>
              ...
              "check-for-minecart-near-item-while-inactive": {
                desc: `是否检查 __非活跃__ 状态的掉落物附近的漏斗矿车，以给予矿车临时免疫，免受 \`interval\` 的影响。
                                    <table>
                                    <tr><td></td><td><b>默认值</b></td><td></td><td></td></tr>
                                    <tr><td><b>推荐值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><i>Leaf</i></td><td><i>Paper</i></td><td><i>原版</i></td></tr>
              ...
              "max-item-horizontal-distance": {
                desc: `漏斗矿车与掉落物的最远水平距离，在此范围内掉落物可以给予矿车临时免疫，以此免受 \`interval\` 的影响。<br>
                                    （单位：方块）<br>
              ...
              "max-item-vertical-distance": {
                desc: `与 \`max-item-horizontal-distance\` 相同，但这是掉落物与漏斗矿车之间的最远垂直距离。<br>
                                    （单位：方块）
                                    <table>
                                    <tr><td></td><td><b>默认值</b></td><td></td><td></td></tr>
                                    <tr><td><b>推荐值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><i>Leaf</i></td><td><i>Paper</i></td><td><i>原版</i></td></tr>
      ...
      "check-stuck-in-wall": {
        desc: `检查实体是否被卡在墙中的频率，以对其造成窒息伤害。<br>
                    （单位：tick）<br>
                    <br>
      ...
      "villager-item-repickup": {
        desc: `村民投掷的掉落物被其他实体拾取的最小延迟。<br>
                    （单位：tick）
                    <ul>
                    <li>防止村民在某些农场设计中优先拾取种植物品，造成漏斗无法拾取; 否则这些设计会因下方的 \`check-nearby-item.hopper\` 而失效。</li>
    ...
    "use-optimized-sheep-offspring-color": {
      desc: `在生成新的绵羊或幼年绵羊时，是否使用更快的逻辑选择羊的颜色。<br>
                选择的颜色与原版完全相同。<br>
                <br>
