---
title: Leaf-Server optimieren
---

import { Callout } from "fumadocs-ui/components/callout"

<Callout type="warn">
  This content is written for versions 1.21.4/5 and may not fully apply to the latest version.
  Please refer to it with discretion.
</Callout>
